      ...
      <div className="mx-8 mb-4">
        <div className="border border-[#2f3336] px-4 py-3 flex gap-3 rounded-2xl">
          ...
          <div className="flex-1 p-3 flex flex-col">
            <header className="mb-0.5 flex items-center">
              <div className="leading-5 text-[15px] font-bold flex items-center">
                X
                <svg
                  viewBox="0 0 24 24"
                  height={18.75}
                  className="text-[#1d9bf0] ml-0.5 pt-0.5"
                >
                  <path
                    fill="currentColor"
            ...
            <div className="text-[15px] leading-5 text-[#e7e9ea]">
              X'in kalbinde, tıpkı buradaki gibi, fotoğraflar, videolar,
              bağlantılar, metinler, etiketler ve şu gibi ifadeler içerebilen
              gönderiler adı verilen kısa mesajlar bulunur: <a href=""className="text-[#1d9bf0] hover:underline transistion-colors">@X</a>
            </div>
          </div>
        </div>
      </div>
