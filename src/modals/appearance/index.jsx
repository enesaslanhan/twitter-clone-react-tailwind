...
import {colors, fontSizes} from "../../assets/utils/consts";
		...
		<div className="w-[600px]">
			...
			<div className="p-8 pt-0">
				...
				<div className="flex items-center justify-center pt-4">
					<button className="bg-[#1d9bf0] rounded-full flex items-center justify-center font-bold hover:bg-[#1a8cd8] duration-300 text-white px-8 h-9" onClick={close}>Bitti</button>
				</div>
